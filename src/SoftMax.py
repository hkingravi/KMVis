...
class SoftMax:
    ...
    def train(self,data,labels):
        ...
        :type data: numpy array
        """        
        res = fmin_l_bfgs_b(softmax_cost, self.theta, fprime=softmax_grad, 
              args=(self.nclasses, self.dim, self.wdecay, data, labels), approx_grad=0, bounds=None, maxfun=400)
        self.theta = reshape(res[0],(self.nclasses,self.dim)) # store returned result 
        print res[0]
        print res[1]
        print res[2]
